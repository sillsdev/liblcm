...
namespace SIL.LCModel
{
	...
	public abstract class ScrInMemoryLcmTestBase : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Adds a Scripture section to the specified book in the mock LcmCache
		/// </summary>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Adds a section (Scripture or Intro) to the sepecified book in the mock LcmCache
		/// </summary>
		/// <param name="book">the book</param>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Add a content paragraph to the specified section in the mock LcmCache
		/// </summary>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Adds a title StText to the specified book in the mock LcmCache
		/// </summary>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Adds a title StText to the specified book in the LcmCache
		/// </summary>
		/// <param name="book">The book.</param>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Adds a book to the mock LcmCache
		/// </summary>
