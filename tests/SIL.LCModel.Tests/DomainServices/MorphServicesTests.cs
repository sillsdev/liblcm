...
namespace SIL.LCModel.DomainServices
{
	...
	public class MatchingMorphsLogicTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		internal class SetupMatchingMorphs : DisposableBase
		{
			...
			static internal void SetupLexEntryAndSense(LcmCache cache, string fullForm, string senseGloss, SandboxGenericMSA msa,
			...
			static internal void AddAllomorph<TAllomorphFactory, TItem>(ILexEntry entry, string allomorphForm, IMoMorphType morphType)
				where TAllomorphFactory : ILcmFactory<TItem>
				where TItem : IMoForm
			{
	...
	{
		static internal ILexEntryInflType InsertInflType<TOwner>(TOwner owningObj, ILcmServiceLocator sl, ITsString variantTypeName, ITsString reverseAbbr,
