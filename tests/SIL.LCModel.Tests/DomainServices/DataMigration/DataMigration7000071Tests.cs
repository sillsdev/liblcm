	...
	public class DataMigration7000071Tests : DataMigrationTestsBase
	{
		...
		public void DataMigration7000071Test()
		{
			...
			try
			{
				...
				// Verify that am-ethi.ldml has been re-named to am-Ethi.ldml and content changed
				Assert.That(File.Exists(Path.Combine(storePath, "am-Ethi.ldml")));
				// Verify that am-Ethi-fonipa.ldml is renamed to am-fonipa and content changed
				Assert.That(File.Exists(Path.Combine(storePath, "am-Ethi-fonipa.ldml")));
				...
				Assert.That(entry.Element("CitationForm").Element("AUni").Attribute("ws").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(sense.Element("Definition").Elements("AStr").Skip(1).First().Attribute("ws").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(sense.Element("Definition").Element("AStr").Elements("Run").Skip(1).First().Attribute("ws").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(sense.Element("LiftResidue").Element("Uni").Value.Contains("lang=\"am-Ethi\""));
				...
				Assert.That(style.Element("Rules").Element("Prop").Element("WsStyles9999").Elements("WsProp").Skip(1).First().Attribute("ws").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(langProj.Element("AnalysisWss").Element("Uni").Value, Is.EqualTo("en am-Ethi"));
				Assert.That(langProj.Element("CurVernWss").Element("Uni").Value, Is.EqualTo("seh am-Ethi fr"));
				Assert.That(langProj.Element("CurAnalysisWss").Element("Uni").Value, Is.EqualTo("en am-Ethi"));
				Assert.That(langProj.Element("CurPronunWss").Element("Uni").Value, Is.EqualTo("am-Ethi"));
				Assert.That(langProj.Element("VernWss").Element("Uni").Value, Is.EqualTo("am-Ethi"));
				Assert.That(langProj.Element("HomographWs").Element("Uni").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(ri.Element("WritingSystem").Element("Uni").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(pl.Element("WritingSystem").Element("Uni").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(cba.Element("WritingSystem").Element("Uni").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(layoutElt.Element("layout").Element("part").Attribute("ws").Value, Is.EqualTo("am-Ethi"));
				...
				Assert.That(layoutElt.Element("layout").Elements("part").Skip(3).First().Attribute("ws").Value, Is.EqualTo("$ws=am-Ethi"));
				Assert.That(layoutElt.Element("layout").Elements("part").Skip(4).First().Attribute("ws").Value, Is.EqualTo("am-Ethi-fonipa,am-Ethi"));
				Assert.That(layoutElt.Element("layout").Elements("part").Skip(4).First().Attribute("visibleWritingSystems").Value, Is.EqualTo("am-Ethi-fonipa,am-Ethi"));

				// Check the local settings.
				XElement propTable = XElement.Parse(File.ReadAllText(sampleSettings, Encoding.UTF8));
				Assert.That(propTable.Element("Property").Element("value").Value.Contains("5062001%am-Ethi"));
				Assert.That(propTable.Element("Property").Element("value").Value.Contains("5112002%am-Ethi"));
				Assert.That(propTable.Element("Property").Element("value").Value.Contains("103%am-Ethi"));
				Assert.That(propTable.Elements("Property").Skip(1).First().Element("value").Value.Contains("ws=\"am-Ethi\""));
				Assert.That(propTable.Elements("Property").Skip(2).First().Element("value").Value.Contains("ws=\"$ws=am-Ethi\""));
				...
				Assert.That(propTable.Elements("Property").Skip(5).First().Element("value").Value, Is.EqualTo("am-Ethi"));
				Assert.That(propTable.Elements("Property").Skip(6).First().Element("value").Value.Contains("ws=\"am-Ethi\""));
				Assert.That(propTable.Elements("Property").Skip(7).First().Element("value").Value.Contains("ws=\"$ws=am-Ethi\""));
			}
			finally
			{
				if (Directory.Exists(projectFolder))
