...
namespace SIL.LCModel.Infrastructure.Impl
{
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Tests for the LcmCache IActionHanlder implementation.
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	[TestFixture]
	public class UnitOfWorkTests : MemoryOnlyBackendProviderTestBase
	{
		...
		internal class MockUndoAction : ILcmPropertyChanged
		{
		...
		public void CollapseToMarkTest()
		{
			...
			Stack<UnitOfWork> undoBundle = (Stack<UnitOfWork>)ReflectionHelper.GetField(m_actionHandler, "m_undoBundles");
			List<UnitOfWork> uowList = undoBundle.ToList();
		...
		public void UndoRedoRemoveScrBookWithChildObjects()
		{
			...
			UndoableUnitOfWorkHelper.Do("Undo create book", "Redo create book", m_actionHandler, () =>
			{
				...
				object owner = new CmObjectId(book.Guid);
