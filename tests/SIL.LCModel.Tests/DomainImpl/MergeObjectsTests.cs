...
namespace SIL.LCModel.DomainImpl
{
	...
	/// </summary>
	[TestFixture]
	public class MergeObjectsTests : ScrInMemoryLcmTestBase
	{
		...
		public void MergeReferenceCollection()
		{
			...
			ILexSense lsSrc = Cache.ServiceLocator.GetInstance<ILexSenseFactory>().Create();
			lme.SensesOS.Add(lsSrc);
			ILcmOwningSequence<ICmPossibility> usageSeq = m_ldb.UsageTypesOA.PossibilitiesOS;
		...
		public void MergeReferenceSequence()
		{
			...
			ILcmOwningSequence<IPhEnvironment> envsSeq = Cache.LangProject.PhonologicalDataOA.EnvironmentsOS;
