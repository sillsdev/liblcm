# Task: Adding a Virtual Property
...
If the property needs to be persisted, see [adding-a-property.md](adding-a-property.md) instead.
...
Test virtual properties using `MemoryOnlyBackendProviderTestBase`. See [writing-tests.md](writing-tests.md).
