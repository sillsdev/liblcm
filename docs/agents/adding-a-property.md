...
If you need a computed/derived property that is NOT persisted, see [adding-a-virtual-property.md](adding-a-virtual-property.md) instead.
...
**API test**: For testing property access via the LCM API, inherit from `MemoryOnlyBackendProviderTestBase`.
