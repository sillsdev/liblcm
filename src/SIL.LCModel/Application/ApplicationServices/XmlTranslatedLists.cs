...
namespace SIL.LCModel.Application.ApplicationServices
{
	...
	public class XmlTranslatedLists
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public bool ImportTranslatedLists(string filename, LcmCache cache, IProgress progress)
		{
#if DEBUG
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public bool ImportTranslatedLists(TextReader reader, LcmCache cache, IProgress progress)
		{
			m_cache = cache;
		...
		public static void ImportTranslatedListsForWs(string ws, LcmCache cache, string templateDir, IProgress progress)
		{
