...
{
	/// <summary>
	/// Implementation of the ISilDataAccess which works with a stateful LCM system for most data issues.
	...
	public abstract class DomainDataByFlidDecoratorBase : SilDataAccessManagedBase, IVwNotifyChange
	{
		...
		/// Constructor.
		/// </summary>
		/// <param name="domainDataByFlid">The LCM DomainDataByFlid implementation,
		/// which is used to get the basic LCM data.</param>
		/// <remarks>
		...
		///
		/// LCM handles notification of all data changes, so this method does not pass the call on
		/// to the LCM SDA implementation.
		///
	...
	/// This could be used for the ley in a subclass of LcmSilDataAccessDecoratorBase.
	/// </summary>
