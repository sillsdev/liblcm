...
//
// <remarks>
// Additions to LCM model interfaces go here.
...
// Add new interfaces to the InterfaceDeclarations.cs file.
namespace SIL.LCModel
{
	...
	public partial interface ICmObject : ICmObjectOrId
	{
		...
		/// </summary>
		ILcmServiceLocator Services { get; }
	...
	public partial interface ILexEntryRef
	{
		...
		/// </summary>
		ILcmReferenceSequence<ICmPossibility> VariantEntryDialectLabels { get; }
	}
	...
	public partial interface ILangProject : IWritingSystemContainer
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		ILcmOwningSequence<ICmPossibility> ScriptureAnnotationDfns
		{
			get;
		}
	...
	public partial interface ILexExampleSentence
	{
		...
		/// SHOULD be published.
		/// </summary>
		ILcmSet<ICmPossibility> PublishIn { get; }
	}
	...
	public partial interface ILexEntry : IVariantComponentLexeme
	{
		...
		/// </summary>
		ILcmSet<ICmPossibility> ShowMainEntryIn { get; }
		...
		/// </summary>
		ILcmReferenceSequence<ILexEntryType> LookupComplexEntryType { get; }
	...
	public partial interface ICmPossibilityList
	{
		...
		/// <param name="ws">writing system</param>
		/// -----------------------------------------------------------------------------------
		ICmPossibility FindPossibilityByName(ILcmOwningSequence<ICmPossibility> possList, string possibilityPath, int ws);
	}
	...
	public partial interface IMoForm
	{
		...
		ILcmReferenceCollection<IPhEnvironment> AllomorphEnvironments { get; }
	}
	...
	public partial interface IStTxtPara : ICloneableCmObject
	{
	   ...
	   ITsString Reference(ISegment seg, int ich);
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		ILcmOwningSequence<IStFootnote> FootnoteSequence { get; }
	...
	public interface ISenseOrEntry
	{
		...
		/// </summary>
		ILcmOwningSequence<ILexEntryRef> PrimaryEntryRefs { get; }
