...
namespace SIL.LCModel.DomainImpl
{
	...
	internal partial class ScrTxtPara
	{
		...
		/// ------------------------------------------------------------------------------------
		protected override IStFootnote CreateBlankDummyFootnote(ILcmOwningSequence<IStFootnote> sequence,
		...
		/// <returns>a blank general footnote</returns>
		/// ------------------------------------------------------------------------------------
		protected override IStFootnote CreateBlankDummyFootnoteNoRecursion(ILcmOwningSequence<IStFootnote> sequence,
			int iFootnote, ITsString paraContents, int iRun)
		{
...
#pragma warning restore 219
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public override ILcmOwningSequence<IStFootnote> FootnoteSequence
		{
			get
			{
		...
		public void CreateOwnedObjects(int ichMin, int ichLim)
		{
			...
			ILcmOwningSequence<IStFootnote> feetnote = FootnoteSequence;
			...
			Guid guidOfObjToCopy, int iRun)
		{
			...
			{
				newFootnote = CopyObject<IScrFootnote>.CloneLcmObject(oldFootnote,
		...
		/// ------------------------------------------------------------------------------------
		private class OwningSequenceWrapper<T, TWrap> : ILcmOwningSequence<T>
			where TWrap : class, T where T : class, ICmObject
		{
			private ILcmOwningSequence<TWrap> m_wrappedSeq;
			...
			/// --------------------------------------------------------------------------------
			public OwningSequenceWrapper(ILcmOwningSequence<TWrap> wrappedSeq)
			{
